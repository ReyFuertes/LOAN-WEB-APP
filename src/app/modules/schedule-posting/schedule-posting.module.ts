import { SchedulePostingContainerComponent } from './container/schedule-posting-container.component';
...
const routes: Routes = [
  {
    path: '',
    component: SchedulePostingContainerComponent,
    children: []
  }
];
...
@NgModule({
  ...
  exports: [],
  declarations: [SchedulePostingContainerComponent],
  providers: [],
})
export class SchedulePostingModule { }
